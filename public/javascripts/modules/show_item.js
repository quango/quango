...
//  $("#close_item_form").hide();
  ...
  $("#request_close_item_form").submit(function() {
  ...
  $(".addNestedAnswer").live("click", function() {
    ...
    if(form.length == 0) // if comment is child of a item
      form = link.parents("#item-body-col").find("form.commentForm");
    var textarea = form.find('textarea');
  ...
  $("#add_comment_link").live('click', function() {
    ...
    var textarea = form.find('textarea');
    $("#request_close_item_form").slideUp();
    $("#item_flag_form").slideUp();
    $("#close_item_form").slideUp();
  ...
  $("#close_item_link").click(function() {
  ...
  $("#item_flag_link.flag-link, #edit_item_flag_link.flag-link").click(function() {
    $("#add_comment_form").slideUp();
    var link = $(this);
    var href = link.attr('href');
    if(!link.hasClass('busy')){
  ...
  $(".item-action").live("click", function(event) {
    var link = $(this);
    if(!link.hasClass('busy')){
      link.addClass('busy');
      var href = link.attr("href");
