...
app.configure{|c|Dragonfly::ImageMagickUtils.convert_command = '/usr/bin/convert'}
app.configure{|c|Dragonfly::ImageMagickUtils.identify_command = '/usr/bin/identify'}
